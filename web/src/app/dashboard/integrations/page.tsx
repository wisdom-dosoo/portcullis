...
const INTEGRATIONS: Integration[] = [
  // identity
  {
    id: "supabase",
    name: "Supabase Auth",
    description: "Use Supabase JWT tokens to authenticate API keys at the gateway level.",
    category: "identity",
    status: "connected",
    lastSync: new Date(Date.now() - 900_000).toISOString(),
    docsUrl: "https://supabase.com/docs/guides/auth",
    configValues: { projectUrl: "https://xyz.supabase.co", jwtSecret: "••••••••" },
    configFields: [
      { key: "projectUrl", label: "Project URL", type: "url", placeholder: "https://xyz.supabase.co", required: true },
      { key: "jwtSecret", label: "JWT Secret", type: "password", placeholder: "your-jwt-secret", required: true },
    ],
  },
  {
    id: "auth0",
    name: "Auth0",
    description: "Delegate authentication to Auth0. Validate JWTs issued by your Auth0 tenant.",
    category: "identity",
    status: "disconnected",
    lastSync: null,
    ...
    configFields: [
      ...
      { key: "audience", label: "API audience", type: "text", placeholder: "https://api.example.com", required: true },
  ...
  },
  {
    id: "clerk",
    name: "Clerk",
    description: "Authenticate users with Clerk sessions. Maps Clerk user IDs to API subjects.",
    category: "identity",
    status: "disconnected",
    lastSync: null,
  ...
  },
  {
    id: "okta",
    name: "Okta",
    description: "Validate Okta access tokens and map groups to Portcullis roles.",
    category: "identity",
    status: "disconnected",
    lastSync: null,
    ...
    configFields: [
      ...
      { key: "clientId", label: "Client ID", type: "text", placeholder: "0oa…", required: true },
      { key: "clientSecret", label: "Client secret", type: "password", placeholder: "••••••••", required: true },
    ],
  },
  {
    ...
    description: "Integrate with Azure AD / Entra ID for enterprise SSO and group-based access.",
    category: "identity",
    status: "disconnected",
    lastSync: null,
    ...
    configFields: [
      ...
      { key: "clientId", label: "Client ID (app registration)", type: "text", placeholder: "xxxxxxxx-…", required: true },
      { key: "clientSecret", label: "Client secret", type: "password", placeholder: "••••••••", required: true },
    ],
  },
  // observability
  {
    id: "opentelemetry",
    name: "OpenTelemetry",
    description: "Export distributed traces, metrics, and logs to any OTLP-compatible backend.",
    category: "observability",
    status: "connected",
    lastSync: new Date(Date.now() - 60_000).toISOString(),
    docsUrl: "https://opentelemetry.io/docs",
    configValues: { endpoint: "https://otel.example.com:4317", protocol: "grpc" },
    configFields: [
      { key: "endpoint", label: "OTLP endpoint", type: "url", placeholder: "https://otel.example.com:4317", required: true },
      { key: "protocol", label: "Protocol", type: "select", placeholder: "grpc", options: ["grpc", "http/protobuf"], required: true },
  ...
  },
  {
    id: "grafana",
    name: "Grafana",
    description: "Push metrics to Grafana Cloud or a self-hosted Grafana instance via Prometheus remote write.",
    category: "observability",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "remoteWriteUrl", label: "Remote write URL", type: "url", placeholder: "https://prometheus-prod.grafana.net/…", required: true },
      { key: "username", label: "Username", type: "text", placeholder: "12345", required: true },
  ...
  },
  {
    id: "datadog",
    name: "Datadog",
    description: "Ship traces and metrics to Datadog APM for end-to-end visibility.",
    category: "observability",
    status: "error",
    lastSync: new Date(Date.now() - 7_200_000).toISOString(),
    docsUrl: "https://docs.datadoghq.com",
    configValues: { apiKey: "••••••••", site: "datadoghq.com" },
    configFields: [
      { key: "apiKey", label: "API key", type: "password", placeholder: "dd-api-…", required: true },
      { key: "site", label: "Datadog site", type: "select", placeholder: "datadoghq.com", options: ["datadoghq.com", "datadoghq.eu", "us3.datadoghq.com", "us5.datadoghq.com"], required: true },
    ],
  },
  {
    id: "sentry",
    name: "Sentry",
    description: "Forward errors and exceptions from the gateway to Sentry for issue tracking.",
    category: "observability",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "dsn", label: "DSN", type: "url", placeholder: "https://xxx@o0.ingest.sentry.io/0", required: true },
  ...
  },
  {
    ...
    configValues: { path: "/metrics", port: "9090" },
    configFields: [
      { key: "path", label: "Metrics path", type: "text", placeholder: "/metrics", required: true },
      { key: "port", label: "Port", type: "text", placeholder: "9090", required: true },
      { key: "bearerToken", label: "Bearer token (optional)", type: "password", placeholder: "••••••••", required: false },
    ],
  },
  // notifications
  {
    id: "slack",
    name: "Slack",
    description: "Send alert notifications and incident updates to Slack channels.",
    category: "notifications",
    status: "connected",
    lastSync: new Date(Date.now() - 300_000).toISOString(),
    docsUrl: "https://api.slack.com/messaging/webhooks",
    configValues: { webhookUrl: "https://hooks.slack.com/services/…", defaultChannel: "#incidents" },
    configFields: [
      { key: "webhookUrl", label: "Webhook URL", type: "url", placeholder: "https://hooks.slack.com/services/…", required: true },
      { key: "defaultChannel", label: "Default channel", type: "text", placeholder: "#incidents", required: false },
    ],
  },
  {
    id: "discord",
    name: "Discord",
    description: "Post alert notifications to Discord channels via webhooks.",
    category: "notifications",
    status: "disconnected",
    lastSync: null,
  ...
  },
  {
    ...
    description: "Post alerts and status updates to Microsoft Teams channels.",
    category: "notifications",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "webhookUrl", label: "Incoming webhook URL", type: "url", placeholder: "https://org.webhook.office.com/…", required: true },
    ],
  },
  {
    id: "email",
    name: "Email",
    description: "Send alert notifications via SMTP or a transactional email provider.",
    category: "notifications",
    status: "connected",
    lastSync: null,
    docsUrl: "#",
    configValues: { smtpHost: "smtp.example.com", fromAddress: "alerts@example.com" },
    configFields: [
      ...
      { key: "username", label: "Username", type: "text", placeholder: "alerts@example.com", required: true },
      { key: "password", label: "Password", type: "password", placeholder: "••••••••", required: true },
      { key: "fromAddress", label: "From address", type: "text", placeholder: "alerts@example.com", required: true },
    ],
  },
  {
    id: "pagerduty",
    name: "PagerDuty",
    description: "Create and resolve PagerDuty incidents automatically from alert rules.",
    category: "notifications",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "integrationKey", label: "Integration key (Events v2)", type: "password", placeholder: "xxxxxxxxxxxxxxxx", required: true },
      { key: "severity", label: "Default severity", type: "select", placeholder: "critical", options: ["critical", "error", "warning", "info"], required: false },
    ],
  },
  // infrastructure
  {
    id: "railway",
    name: "Railway",
    description: "Auto-discover MCP servers deployed on Railway and register them via service metadata.",
    ...
    configValues: {},
    configFields: [
      { key: "apiToken", label: "API token", type: "password", placeholder: "railway-token-…", required: true },
      { key: "projectId", label: "Project ID (optional)", type: "text", placeholder: "project-uuid", required: false },
    ],
  },
  {
    id: "render",
    name: "Render",
    description: "Discover and register MCP services deployed on Render via the Render API.",
    category: "infrastructure",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "apiKey", label: "API key", type: "password", placeholder: "rnd_…", required: true },
      { key: "serviceTag", label: "Service tag filter (optional)", type: "text", placeholder: "mcp", required: false },
    ],
  },
  {
    id: "cloudflare",
    name: "Cloudflare",
    description: "Use Cloudflare Workers to front the gateway and apply edge-level rate limiting.",
    category: "infrastructure",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "apiToken", label: "API token", type: "password", placeholder: "cloudflare-api-token", required: true },
      { key: "zoneId", label: "Zone ID", type: "text", placeholder: "zone-id", required: true },
    ],
  },
  {
    id: "neon",
    name: "Neon",
    description: "Store audit logs and telemetry in a Neon serverless Postgres database.",
    category: "infrastructure",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "connectionString", label: "Connection string", type: "password", placeholder: "postgres://user:pass@ep-…neon.tech/dbname", required: true },
    ],
  },
  {
    id: "redis",
    name: "Redis Cloud",
    description: "Use Redis Cloud as the distributed cache for rate limiting state.",
    category: "infrastructure",
    status: "disconnected",
    lastSync: null,
    docsUrl: "https://redis.io/docs/latest/operate/rc",
    configValues: {},
    configFields: [
      { key: "url", label: "Redis URL", type: "password", placeholder: "redis://default:pass@host:port", required: true },
    ],
  },
  {
    id: "upstash",
    name: "Upstash",
    description: "HTTP-based Redis via Upstash for serverless-friendly rate limit state storage.",
    category: "infrastructure",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "restUrl", label: "REST URL", type: "url", placeholder: "https://xxx.upstash.io", required: true },
      { key: "restToken", label: "REST token", type: "password", placeholder: "AX…", required: true },
    ],
  },
  // developer
  {
    id: "github",
    name: "GitHub",
    description: "Trigger policy and server syncs on push events. Link incidents to GitHub issues.",
    category: "developer",
    status: "connected",
    lastSync: new Date(Date.now() - 1_800_000).toISOString(),
    docsUrl: "https://docs.github.com/en/developers/webhooks-and-events",
    configValues: { webhookSecret: "••••••••", org: "my-org" },
    configFields: [
      { key: "token", label: "Personal access token", type: "password", placeholder: "ghp_…", required: true },
      { key: "org", label: "Organization", type: "text", placeholder: "my-org", required: false },
      { key: "webhookSecret", label: "Webhook secret", type: "password", placeholder: "••••••••", required: false },
    ],
  },
  {
    id: "gitlab",
    name: "GitLab",
    description: "Sync configuration from GitLab repos and link incidents to GitLab issues.",
    category: "developer",
    status: "disconnected",
    lastSync: null,
    ...
    configFields: [
      ...
      { key: "baseUrl", label: "GitLab URL (self-hosted)", type: "url", placeholder: "https://gitlab.example.com", required: false },
    ],
  },
  {
    id: "vercel",
    name: "Vercel",
    description: "Deploy and update gateway configuration from Vercel project environments.",
    category: "developer",
    status: "disconnected",
    lastSync: null,
  ...
  },
  {
    id: "postman",
    name: "Postman",
    description: "Export gateway API schemas to Postman collections for testing and documentation.",
    category: "developer",
    status: "disconnected",
    lastSync: null,
    docsUrl: "https://www.postman.com/postman/workspace/postman-public-workspace",
    configValues: {},
    configFields: [
      { key: "apiKey", label: "API key", type: "password", placeholder: "PMAK-…", required: true },
      { key: "workspaceId", label: "Workspace ID (optional)", type: "text", placeholder: "workspace-uuid", required: false },
    ],
  },
  // ── identity additions ────────────────────────────────────────────────────
  {
    id: "cognito",
    name: "AWS Cognito",
    description: "Validate Cognito user pool JWTs and map Cognito groups to Portcullis roles.",
    category: "identity",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "userPoolId", label: "User pool ID", type: "text", placeholder: "us-east-1_xxxxxxxxx", required: true },
      { key: "clientId", label: "App client ID", type: "text", placeholder: "xxxxxxxxxxxxxxxxxxxxxxxxxx", required: true },
      { key: "region", label: "AWS region", type: "select", placeholder: "us-east-1", options: ["us-east-1","us-east-2","us-west-1","us-west-2","eu-west-1","eu-central-1","ap-southeast-1","ap-northeast-1"], required: true },
    ],
  },
  {
    id: "google_workspace",
    name: "Google Workspace",
    description: "Authenticate with Google OAuth 2.0 and map Google Workspace groups to roles.",
    category: "identity",
    status: "disconnected",
    lastSync: null,
    ...
    configFields: [
      ...
      { key: "hostedDomain", label: "Hosted domain (optional)", type: "text", placeholder: "yourcompany.com", required: false },
    ],
  },
  {
    id: "keycloak",
    name: "Keycloak",
    description: "Connect to a self-hosted Keycloak realm for JWT validation and role mapping.",
    category: "identity",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "realmUrl", label: "Realm URL", type: "url", placeholder: "https://auth.example.com/realms/myrealm", required: true },
      { key: "clientId", label: "Client ID", type: "text", placeholder: "portcullis", required: true },
      { key: "clientSecret", label: "Client secret", type: "password", placeholder: "••••••••", required: true },
    ],
  },
  // ── observability additions ───────────────────────────────────────────────
  {
    id: "newrelic",
    name: "New Relic",
    description: "Send traces, metrics, and logs to New Relic One for full-stack observability.",
    category: "observability",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "licenseKey", label: "License key", type: "password", placeholder: "NRAK-…", required: true },
      { key: "accountId", label: "Account ID", type: "text", placeholder: "1234567", required: true },
      { key: "region", label: "Region", type: "select", placeholder: "US", options: ["US", "EU"], required: false },
    ],
  },
  {
    id: "honeycomb",
    name: "Honeycomb",
    description: "Ship structured events and distributed traces to Honeycomb for query-based debugging.",
    category: "observability",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "apiKey", label: "API key", type: "password", placeholder: "hcaik_…", required: true },
      { key: "dataset", label: "Dataset", type: "text", placeholder: "portcullis", required: true },
    ],
  },
  {
    id: "dynatrace",
    name: "Dynatrace",
    description: "Export OpenTelemetry data to Dynatrace for AI-powered root cause analysis.",
    category: "observability",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "environmentId", label: "Environment ID", type: "text", placeholder: "abc12345", required: true },
      { key: "apiToken", label: "API token", type: "password", placeholder: "dt0c01.…", required: true },
      { key: "endpoint", label: "OTLP endpoint (optional)", type: "url", placeholder: "https://xxx.live.dynatrace.com/api/v2/otlp", required: false },
    ],
  },
  // ── notifications additions ───────────────────────────────────────────────
  {
    id: "opsgenie",
    name: "Opsgenie",
    description: "Create and auto-close Opsgenie alerts from Portcullis alert rules and incidents.",
    category: "notifications",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "apiKey", label: "API key", type: "password", placeholder: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", required: true },
      { key: "region", label: "Region", type: "select", placeholder: "US", options: ["US", "EU"], required: false },
      { key: "team", label: "Default team (optional)", type: "text", placeholder: "platform-oncall", required: false },
    ],
  },
  {
    id: "telegram",
    name: "Telegram",
    description: "Deliver alert notifications to a Telegram group or channel via a bot.",
    category: "notifications",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "botToken", label: "Bot token", type: "password", placeholder: "1234567890:AABB…", required: true },
      { key: "chatId", label: "Chat ID", type: "text", placeholder: "-100xxxxxxxxxx", required: true },
    ],
  },
  {
    id: "twilio",
    name: "Twilio",
    description: "Send SMS and voice call alerts via Twilio for critical on-call escalations.",
    category: "notifications",
    status: "disconnected",
    lastSync: null,
    ...
    configFields: [
      ...
      { key: "fromNumber", label: "From phone number", type: "text", placeholder: "+15551234567", required: true },
      { key: "toNumber", label: "Default to number", type: "text", placeholder: "+15559876543", required: false },
    ],
  },
  // ── infrastructure additions ──────────────────────────────────────────────
  {
    id: "flyio",
    name: "Fly.io",
    description: "Auto-discover MCP server apps deployed on Fly.io by machine label.",
    category: "infrastructure",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "apiToken", label: "API token", type: "password", placeholder: "FlyV1 …", required: true },
      { key: "orgSlug", label: "Org slug", type: "text", placeholder: "my-org", required: false },
      { key: "appLabel", label: "Label filter (optional)", type: "text", placeholder: "mcp", required: false },
    ],
  },
  {
    id: "aws",
    name: "AWS",
    description: "Discover MCP workloads on ECS, Lambda, or EC2 using AWS service discovery tags.",
    category: "infrastructure",
    status: "disconnected",
    lastSync: null,
    ...
    configFields: [
      ...
      { key: "region", label: "Default region", type: "select", placeholder: "us-east-1", options: ["us-east-1","us-east-2","us-west-1","us-west-2","eu-west-1","eu-central-1","ap-southeast-1","ap-northeast-1"], required: true },
      { key: "tagKey", label: "Discovery tag key", type: "text", placeholder: "portcullis-server", required: false },
    ],
  },
  {
    id: "planetscale",
    name: "PlanetScale",
    description: "Use PlanetScale as the primary database for audit logs and gateway configuration.",
    category: "infrastructure",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "connectionString", label: "Connection string", type: "password", placeholder: "mysql://user:pass@host/db?sslmode=require", required: true },
      { key: "branch", label: "Branch", type: "text", placeholder: "main", required: false },
    ],
  },
  // ── developer tool additions ──────────────────────────────────────────────
  {
    id: "linear",
    name: "Linear",
    description: "Create Linear issues from Portcullis incidents and link error groups to cycles.",
    category: "developer",
    status: "disconnected",
    lastSync: null,
    ...
    configFields: [
      ...
      { key: "teamId", label: "Team ID", type: "text", placeholder: "TEAM-uuid", required: true },
      { key: "defaultPriority", label: "Default priority", type: "select", placeholder: "high", options: ["urgent","high","medium","low","no priority"], required: false },
    ],
  },
  {
    id: "jira",
    name: "Jira",
    description: "Create Jira tickets from incidents and sync resolution status back to Portcullis.",
    category: "developer",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "baseUrl", label: "Jira base URL", type: "url", placeholder: "https://yourorg.atlassian.net", required: true },
      { key: "email", label: "Account email", type: "text", placeholder: "you@example.com", required: true },
      { key: "apiToken", label: "API token", type: "password", placeholder: "ATATT3x…", required: true },
      { key: "projectKey", label: "Project key", type: "text", placeholder: "OPS", required: true },
    ],
  },
  {
    id: "terraform",
    name: "Terraform",
    description: "Manage Portcullis server registrations and policies as Terraform resources via the provider.",
    category: "developer",
    status: "disconnected",
    lastSync: null,
    ...
    configValues: {},
    configFields: [
      { key: "workspaceUrl", label: "Terraform Cloud workspace URL", type: "url", placeholder: "https://app.terraform.io/app/org/workspaces/portcullis", required: false },
      { key: "token", label: "Team API token", type: "password", placeholder: "••••••••", required: false },
    ],
  },
];
