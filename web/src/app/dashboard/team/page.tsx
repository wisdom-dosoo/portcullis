...
function MembersTab({ roles, isLoading }: { roles: RoleView[]; isLoading: boolean }) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: "var(--pc-muted)" }}>
            Manage members, role archetypes, and access permissions
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-1">
        ...
        <TabButton active={tab === "members"} onClick={() => setTab("members")}>
          <span className="flex items-center gap-2"><Users className="w-3.5 h-3.5" strokeWidth={1.75} />Members</span>
        </TabButton>
      ...
      {tab === "members" && <MembersTab roles={roles} isLoading={isLoading} />}
